    ...
    <div class="flex-grow flex items-center justify-center">
        <div class="bg-white shadow-md rounded-lg p-8 w-96">
            ...
            <form id="troubleshootForm">
                ...
                <div class="mb-4">
                    <textarea id="description" placeholder="Description" class="w-full p-2 border border-gray-300 rounded"></textarea>
                </div>
...
<script>
    ...
    function confirmAction() {
        ...
        setTimeout(function() {
            ...
            xhr.open("POST", "../controller/troubleshootController.php", true);
            ...
            xhr.send("action=create&admin_id=" + encodeURIComponent(accountId) + "&details=" + encodeURIComponent(description));
        }, 500);
    }
