...
<body id="login-page">
    <div class="login-container">
        ...
        <!--header-->
        <div>
            <h2 class="text-xl font-bold">Welcome to FaceLock!</h2>
        </div>
        <!--image-->
        <img class="logo mt-3" src="../view/images/logo.jpg" height="130" width="130" alt="Logo">
        <!-- <img class="logo mt-3" src="images/logo.jpg" height="130" width="130" alt="Logo"> -->
