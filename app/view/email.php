...
function send_success_payment_email($to, $name, $subject, $content){
    ...
    try {
        ...
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = $subject;
        $mail->Body    = "Dear $name,<br><br><font size='4'>Your Payment for ".$content."was successful. Thank you for your purchase! <br>
        </font>";
        ...
        echo "Payment unsuccessful. Mailer Error: {$mail->ErrorInfo}";
    }
