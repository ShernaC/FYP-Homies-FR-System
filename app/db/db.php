...
$config = [
    ...
    $sql_troubleshoot = "CREATE TABLE IF NOT EXISTS troubleshoot (
        troubleshoot_id INT AUTO_INCREMENT PRIMARY KEY,
        admin_id BIGINT UNSIGNED NOT NULL,
        details TEXT NOT NULL,
        FOREIGN KEY (admin_id) REFERENCES sysadmin(id)
    )";
