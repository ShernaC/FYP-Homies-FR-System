...
//     if (mysqli_num_rows($rs_sysadmin) > 0) {
//         $sql = "UPDATE sysadmin SET user_otp='$otp' WHERE email='$email'";
//     } else {
//         $sql = "UPDATE businessowner SET user_otp='$otp' WHERE email='$email'";
//     }
    
//     $rs = mysqli_query($conn, $sql) or die(mysqli_error($conn));
//     // header("location:verify.php?msg=Please check your email For the OTP and verify.");
// } else {
