...
excel_file_path = r'C:\xampp\htdocs\otp_test\FYP-Homies-FR-System\app\uploadsExcel\companyNameList.xlsx'
...
model_path = r"C:\xampp\htdocs\otp_test\FYP-Homies-FR-System\app\modelDownload\disc_stop_15_lr1.pth" #change file path accordingly
...
def evaluate_and_save_image(image_path, model, device, image_size, tier, approved_images_dir, extract_path):
    ...
    if is_fake_or_real(model, image_path, device, image_size):
...
local_paths = {
    'shape_predictor_68_face_landmarks.dat': r'C:\xampp\htdocs\otp_test\FYP-Homies-FR-System\app\modelDownload\shape_predictor_68_face_landmarks.dat',
    'dlib_face_recognition_resnet_model_v1.dat': r'C:\xampp\htdocs\otp_test\FYP-Homies-FR-System\app\modelDownload\dlib_face_recognition_resnet_model_v1.dat'
}
...
def main(zip_path, excel_file_path, tier, model, device, image_size):
    ...
    approved_images_dir = r'C:\xampp\htdocs\otp_test\FYP-Homies-FR-System\app\ApprovedImages'
    ...
    if os.path.exists(zip_path):
        if is_all_images(zip_path):
            ...
            extract_path = os.path.join('C:/xampp/htdocs/otp_test/FYP-Homies-FR-System/app/new/uploads', zip_name)
