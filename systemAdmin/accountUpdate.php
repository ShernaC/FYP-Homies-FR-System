    ...
    <div class="w-full max-w-6xl mt-4 bg-white shadow-md rounded-lg p-4">
        ...
        <form class="space-y-4" onsubmit="return validateForm()">
            ...
            <div>
                ...
                <input value="<?php echo $accounts["password"]; ?>" type="password" id="password" placeholder="System Admin, Business Owner only" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
