                ...
                <div class="bottom-visiting-top">
                    ...
                    <div class="visiting-top-texts">
                        <div class="large-font">
                            <img src="static/images/user-solid.svg" alt="name icon" style="width: 20px; height: 20px;">
                            <i>Name:xxx</i>
                        </div>
                        <div class="large-font">
                            <img src="static/images/phone-solid.svg" alt="phone icon" style="width: 20px; height: 20px;">
                            <i>Phone:xxx</i>
                        </div>
                    </div>
                </div>
